 ...
 */
public class EveningShiftRecyclerAdapter extends RecyclerView.Adapter<EveningShiftRecyclerAdapter.ViewHolder> {
    ...
    public EveningShiftRecyclerAdapter(Activity activity, ArrayList<BusStop> arrayList) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        BusStop eveningShift = arrayList.get(position);
