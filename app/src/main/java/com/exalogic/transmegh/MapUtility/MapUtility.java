...
public class MapUtility {
    ...
    public static double distance(double lat1, double lng1, double lat2, double lng2) {
        ...
        Log.e("hvdsaudsvhgdsvgsdvdsgah :", sindLat + "");
        Log.e("hvdsaudsvhgdsvgsdvdsgah :", sindLng + "");
...
//    }
    ...
    public void animateMarker(final Marker marker, final LatLng toPosition, final boolean hideMarker, GoogleMap googleMap) {
        final Handler handler = new Handler();
        final long start = SystemClock.uptimeMillis();
